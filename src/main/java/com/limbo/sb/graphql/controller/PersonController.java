package com.limbo.sb.graphql.controller;

import com.limbo.sb.graphql.entity.Person;
import com.limbo.sb.graphql.dao.PersonRepository;
...
public class PersonController {
    ...
    private RuntimeWiring buildWiring() {
        ...
        return RuntimeWiring.newRuntimeWiring().type("Query",typeWiring->
            typeWiring.dataFetcher("getAllPerson", fetcher1).dataFetcher("findPerson",fetcher2)).build();
    }
